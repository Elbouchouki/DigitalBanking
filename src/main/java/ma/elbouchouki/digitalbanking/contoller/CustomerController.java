...
public class CustomerController {
    ...
    public ResponseEntity<PagingResponse<CustomerResponse>> getAll(
            ...
            @RequestParam(defaultValue = "id", required = false) boolean includeBankAccounts,
            @RequestParam(defaultValue = "id", required = false) boolean includeOperations
    ) {
        return ResponseEntity.ok(
                service.findAll(page, size, search, includeBankAccounts, includeOperations)
        );
    }
    ...
    public ResponseEntity<CustomerResponse> get(
        ...
        return ResponseEntity.ok(
                service.findById(id, includeBankAccounts, includeOperations)
        );
    }
